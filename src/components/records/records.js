      ...
      contents: [
        {
          ...
          info: {
            main: '서버에서 발생하는 로그 기록을 관리하는 ‘Log & Crash’ 클라우드 서비스의 테이블 컴포넌트 기능 개발 및 로그데이터 테스트 백오피스 화면 개발 프로젝트 참여',
            sub: [
        ...
        },
        {
          ...
          info: {
            main: 'AI 반려견 행동분석 ‘도기보기’ 앱을 배포하며 새로운 기능 추가 및 유지 보수',
            sub: [
